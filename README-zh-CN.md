...
* ~~**macOS**~~（Apple Silicon, arm64）安装完毕后需要`系统设置`-`安全&隐私`中允许启动Hummingbird
* ~~**macOS**~~（Intel）
* <a href="https://github.com/leibnizli/hummingbird/releases/download/v5.3.0/hummingbird-Setup-5.3.0.exe">**Windows**</a> (>=10)
* <a href="[https://apps.apple.com/us/app/id6755109910](https://apps.apple.com/cn/app/id6755109910)">**iPhone, iPad, and Mac**</a>（Apple Silicon，强大的个性化配置）
